...
@implementation wjContactHeaderView

+(instancetype)headerView{
//    return [[[NSBundle mainBundle] loadNibNamed:NSStringFromClass(self) owner:nil options:nil] lastObject];
    
    //两个按钮
    wjContactHeaderView *headerView = [[wjContactHeaderView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 90)];
    return headerView;
}
